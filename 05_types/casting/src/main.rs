// Rust provides no implicit conversion (coercion) between primitive types.
...
fn main() {
    ...
    unsafe {
        // 300.0 is 44
        println!(
            "300.0.to_int_unchecked::<u8>() is {}",
            300.0_f32.to_int_unchecked::<u8>()
        );
        // -100.0 as u8 is 156
        println!(
            "(-100.0_f32).to_int_unchecked::<u8>() is {}",
            (-100.0_f32).to_int_unchecked::<u8>()
        );
        // nan as u8 is 0
        println!(
            "f32::NAN.to_int_unchecked::<u8>() is {}",
