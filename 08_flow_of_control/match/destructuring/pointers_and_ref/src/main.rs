// For pointers, a distinction needs to be made between destructuring and dereferencing as they
...
fn main() {
    // Assign a reference of type `i32`. The `&` signifies there is
    // a reference being assigned.
    let reference = &4;
    ...
    // To avoid the `&`, we dereference before matching
    match *reference {
